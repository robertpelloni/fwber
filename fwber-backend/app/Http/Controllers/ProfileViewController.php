...
class ProfileViewController extends Controller
{
    ...
    public function recordView(Request $request, $userId)
    {
        ...
        // Double check DB in case cache was cleared but DB record exists (less likely but safer)
    ...
    public function getStats(Request $request, $userId)
    {
        ...
        $cacheKey = "profile_stats:{$userId}";

        return Cache::remember($cacheKey, 300, function () use ($userId) { // Cache stats for 5 minutes

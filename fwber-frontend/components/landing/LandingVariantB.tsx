...
import { Shield, Heart, Zap, MapPin, MessageCircle, Users, Lock, Ghost, Layers, Code, CheckCircle2, Sparkles, Flame, Link as LinkIcon, Gift, Home, UserPlus, Star } from 'lucide-react'

    ...
    >
      ...
      <div className="mt-5 flex flex-wrap gap-2 text-xs text-gray-500">
        {topic.aliases.slice(0, 4).map((alias) => (
          <span key={alias} className="rounded-full bg-gray-100 px-3 py-1 font-medium">
            #{alias}
          </span>
        ))}
      </div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 text-sm text-gray-600 sm:grid-cols-4">
        <div className="rounded-2xl bg-gray-50 px-3 py-3">
          ...
          <div className="mt-2 text-lg font-semibold text-gray-900">{topic.follower_count}</div>
        </div>
        <div className="rounded-2xl bg-gray-50 px-3 py-3">
          <div className="flex items-center gap-2 text-gray-500">
          ...
          <div className="mt-2 text-lg font-semibold text-gray-900">{topic.group_count}</div>
        </div>
        <div className="rounded-2xl bg-gray-50 px-3 py-3">
          <div className="flex items-center gap-2 text-gray-500">
          ...
          <div className="mt-2 text-lg font-semibold text-gray-900">{topic.journal_count}</div>
        </div>
        <div className="rounded-2xl bg-gray-50 px-3 py-3">
          <div className="flex items-center gap-2 text-gray-500">
          ...
          <div className="mt-2 text-lg font-semibold text-gray-900">{topic.artifact_count}</div>
        </div>
      </div>
    </Link>
  )

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const publicPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/rate-my-pussy`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
  ...
  const authPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/forgot-password`, lastModified: now, changeFrequency: 'monthly', priority: 0.3 },
    { url: `${baseUrl}/reset-password`, lastModified: now, changeFrequency: 'monthly', priority: 0.3 },
  ]

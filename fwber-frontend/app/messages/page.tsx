		...
		<ProtectedRoute>
								...
								<div className="overflow-y-auto h-[calc(100%-80px)]">
									{conversations.map((conversation) => (
										<div
											...
											className={`p-4 border-b cursor-pointer hover:bg-gray-50 dark:bg-gray-900 ${
							...
							<div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-lg shadow flex flex-col overflow-hidden">
								{selectedConversation ? (
									<ErrorBoundary>
										...
										recipientAvatar={
											selectedConversation.other_user?.profile?.photos?.[0]
												?.url || "/placeholder-avatar.png"
										}
										recipientEmotion={
											selectedConversation.other_user?.profile?.current_emotion
										}
										className="h-full"
			...
			{isAROpen && selectedConversation && token && (
				<MatchARView
					...
					matchName={
						selectedConversation.other_user?.profile?.display_name || "Match"
					}
					token={token}
			...
			{selectedConversation && (
				<ReportModal
					...
					userName={
						selectedConversation.other_user?.profile?.display_name || "User"
					}
				/>
			)}
				...
				<VideoCallModal
					recipientId={
						incomingCall
							...
							: String(selectedConversation!.other_user!.id)
					}

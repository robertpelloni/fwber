...
## 3. Account Creation and Avatar Mode

### Account Types

**Standard Mode:**
- Create profiles with personal photos and information
- Standard matching and discovery features

**Avatar Mode (When Enabled):**
- **AI-generated avatars are mandatory** for all profiles
- Personal photos are prohibited
- Profile content must comply with avatar-only guidelines
- Attempting to circumvent Avatar Mode restrictions will result in account suspension
...
- Do not create accounts for illegal purposes
...
- Share explicit sexual content or pornography
- Post content promoting violence, hate, or discrimination
...
- Use automated tools (bots, scripts) without authorization
- Manipulate or abuse matching algorithms
- Create fake accounts or engage in sockpuppeting

**Location Abuse:**
- Spoof or falsify your geolocation
- Use VPNs or proxies to manipulate proximity features
- Attempt to identify other users' exact locations
- Exploit location-based features for surveillance

**Commercial Violations:**
- Advertise or sell products/services without authorization
...
## 6. Proximity Features and Location

### Geolocation

- Proximity features require location access
- Your exact location is never disclosed to other users
- We apply location fuzzing for privacy
- You can disable location services (this limits proximity features)
- Location data is used only for matching and discovery

### Proximity Artifacts

- Artifacts (chat invitations, posts, announcements) expire automatically
- Expired content is permanently deleted
- You are responsible for content you create
- Flagged content will be reviewed and may be removed

### Local Pulse

- Displays nearby artifacts and match candidates
- Data refreshes periodically (not real-time)
- Shown users are approximate matches based on location and compatibility
- Distance shown is approximate, not exact
...
- Review and remove content that violates these Terms
- Suspend or terminate accounts for violations
- Implement shadow throttling for repeat offenders
- Cooperate with law enforcement

### Flagging and Reports
...
2. **Content Removal:** Violating posts deleted
3. **Temporary Suspension:** 7-30 day account suspension
4. **Shadow Throttling:** Reduced visibility for repeat offenders
5. **Permanent Ban:** Severe or repeated violations

Appeals can be submitted to [appeals@fwber.example.com].
...
Please review the Privacy Policy at [PRIVACY.md].

### Data Security

While we implement industry-standard security measures, we cannot guarantee absolute security. Use strong passwords and enable two-factor authentication when available.
...
- We do not verify user identities or conduct background checks
- Exercise caution when meeting people from the internet
...
**Notice of material changes will be provided via:**
- Email notification
- In-app notification
...
You may delete your account at any time through account settings. Deletion is permanent and irreversible.
...
- Fail to respond to moderation requests

### Effect of Termination

Upon termination:
- Your access to the Service ends immediately
- Your content may be deleted (subject to retention policies)
- These Terms survive termination where applicable (indemnification, liability limitations)
...
You may not assign these Terms. We may assign these Terms without notice (e.g., in a merger or acquisition).

### Force Majeure

We are not liable for delays or failures due to circumstances beyond our reasonable control (natural disasters, war, strikes, etc.).

### Contact

For questions about these Terms, contact us at:
- **Email:** [legal@fwber.example.com]

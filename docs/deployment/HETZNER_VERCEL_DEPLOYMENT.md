...
19. Re-run websocket smoke validation and confirm no probe-side false negative remains
20. Validate auth, roast, premium, merchant, websocket, and health endpoints

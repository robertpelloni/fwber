...
<label class="checkbox text-left d-sm-inline-block mb-0"><input type="checkbox" onclick="toggle(this)" name="b_noPsychedelics" 				value="b_noPsychedelics" 			<?php if($profileDone==1&&$b_noPsychedelics==1	)echo 'checked="checked"'; ?>> No Psychedelics</input></label><br>

...
- the restore branch has now entered a direct-compatibility-fix phase as well, with local fixes for event-store/event-bus drift and missing frontend primitives layered on top of the replayed Hetzner contract

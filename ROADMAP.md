...
1. Expand the shipped **scene discovery** stack from Local Pulse, recommendations, nearby chatrooms, and event trust-aware ranking into the remaining local-feed and discovery loops.

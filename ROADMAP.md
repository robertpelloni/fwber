...
1. Expand the shipped **scene discovery** stack from Local Pulse, recommendations, and nearby chatroom trust-aware ranking into the remaining local-feed and discovery loops.

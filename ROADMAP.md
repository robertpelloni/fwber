...
> **Current Version:** 1.8.5 "Smoke Check Timeout + Roast Fallback Hardening"
...
1. **Confirm Green GitHub Hetzner Deploy + Verify Referral/Video/Roast Surface:** Verify live `/wallet`, referral signup, vouch links, roast preview, and video-chat initiation/history after the latest smoke hardening ships.

...
1. Expand the shipped **scene discovery** stack from Local Pulse, recommendations, nearby chatrooms, events, and bulletin board trust-aware ranking into the remaining local-feed and discovery loops.
